...
return array(
    array(
        ...
        "props"           => array(
            "message" => "Winter Holidays Special Offer - <span style='color:red'>20% discount </span> for <strong>One Page Express PRO</strong>",
            "buttons" => array(
                array(
                    'class' => 'primary main',
                    'link'  => 'http://onepageexpress.com/#pricing',
                    'label' => 'Get the offer',
                ),
                array(
                    'class' => 'primary',
                    'label' => 'See PRO Features',
                    'link'  => 'http://onepageexpress.com/#features-6',
                ),
            ),
        ),
